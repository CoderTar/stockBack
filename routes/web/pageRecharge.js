...
router.post('/', function (req, res, next) {
    ...
    var sql = 'select * from stock_user_recharge ORDER BY id  DESC limit ?,?'
    ...
    db.query(sql, data, (err, data) => {
        ...
        if (err) {
            ...
            console.log("用户充值记录", data)

            let sqlTotal = 'select count(*) as total from stock_user_recharge' //as更换名称
